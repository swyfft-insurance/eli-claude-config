...
```powershell
& "$HOME/.claude/skills/excel-edit/Edit-Excel.ps1" -Path "C:\...\HO_ES_BSIC_NC_Rater.xlsm" -SpecPath "C:\...\scratch\nc-edit.json"
```

Inline spec instead of a file:

```powershell
& "$HOME/.claude/skills/excel-edit/Edit-Excel.ps1" -Path "<file>" -Spec '{"cells":[{"sheet":"Fees","cell":"C4","formula":"=IF(InspectionFeeRequired,100,35)"}]}'
```
