...
- **Excel test docs:** `Swyfft.Services.Excel.IntegrationTests/CLAUDE.md`; `~/.claude/rules/testing-execution.md` § "Validation surface is per product line" (the Commercial validation surface — do **not** default to the HO `/prebind-validation` suite).
